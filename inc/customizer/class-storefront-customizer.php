		...
		public function get_storefront_default_setting_values() {
			return apply_filters(
				'storefront_setting_default_values', $args = array(
					...
					//'storefront_header_background_image_size' 	=> 'cover',
					//'storefront_header_background_image_pos' 	=> 'center',
					//'storefront_header_has_header_image_height' => '50vh',
					'storefront_header_background_color' 		=> '#ffffff',
					'storefront_header_text_color'       		=> '#404040',
					'storefront_header_link_color'       		=> '#333333',
					'storefront_footer_background_color' 		=> '#fefefe',
		...
		public function customize_register( $wp_customize ) {
			...
			$wp_customize->add_setting(
				'storefront_footer_background_color', array(
					'default'           => apply_filters( 'storefront_default_footer_background_color', '#fefefe' ),
					'sanitize_callback' => 'sanitize_hex_color',
				)
			);
