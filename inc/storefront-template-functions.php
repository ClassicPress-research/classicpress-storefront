	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<?php if ( apply_filters( 'storefront_credit_link', true ) ) { ?>
				...
				?>
				<?php echo '<a href="https://classicpress.net" target="_blank" title="' . esc_attr__( 'ClassicPress', 'storefront' ) . '" rel="author">' . esc_html__( ' ~ Built with ❤ and ClassicPress', 'storefront' ) . '</a>.'; ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
...
if ( ! function_exists( 'storefront_handheld_navigation' ) ) {
	...
	function storefront_handheld_navigation() {
		?>
		<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_html_e( 'Handheld Navigation', 'storefront' ); ?>">
		<button class="menu-toggle" aria-controls="site-navigation" aria-expanded="false"><span><?php echo esc_attr( apply_filters( 'storefront_menu_toggle_text', __( 'Menu', 'storefront' ) ) ); ?></span></button>
			<?php
...
if ( ! function_exists( 'storefront_read_more' ) ) {
	/**
	 * Display read more button
	 *
	 * @since 1.0.0
	 */
	function storefront_read_more() {
	?> 
		<p class="read-more">
			<a class="button" href="<?php the_permalink(); ?>">
				<?php echo __( 'Read more', 'storefront' ); ?>
			</a>
		</p>
	<?php }
}
